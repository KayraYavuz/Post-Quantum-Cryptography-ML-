...
- 2026-09-16T04:50:00Z | [WS-C.1] GE uyumlu yan kanal ayarları ve 1./2. mertebe ayrımı tamamlandı - Gaussian error modeling, σ/q threshold analysis | state: DONE
- 2026-09-16T05:00:00Z | [WS-C.2] GPU allocate ve yan kanal başlatma - CPU-only optimized implementations | state: DONE
- 2026-09-16T05:10:00Z | [WS-C.3] Yan kanal testi ve doğrulama - LWE sonuçlarını GE uyumlu formatta test etme | state: IN_PROGRESS
<parameter=command>
