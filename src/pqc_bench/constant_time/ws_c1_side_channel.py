...
def export_tier_report(results: dict, output_path: Path) -> Path:
    """Export tier analysis results to a JSON report file."""
    report = {
        "algorithm": results["algorithm"],
        "cells_analyzed": results["cells_analyzed"],
...
if __name__ == "__main__":
    ...
    # Export tier report
    report_path = export_tier_report(matrix_result, Path("artifacts/tier-analysis-report.json"))
    print(f"Tier analysis report written to: {report_path}")
